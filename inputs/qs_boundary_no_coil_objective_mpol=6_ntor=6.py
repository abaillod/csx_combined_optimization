...
inputs['CS_WEIGHT'] = Weight(1E+0)
inputs['CC_THRESHOLD'] = 0.08
inputs['CC_WEIGHT'] = Weight(1E+0)

# SURFACE
inputs['vmec'] = dict()
inputs['vmec']['filename'] = 'runs/2023-10-18T22:51:12/input.final' 
inputs['vmec']['verbose'] = False
inputs['vmec']['nphi'] = 34
inputs['vmec']['ntheta'] = 34

inputs['vmec']['dofs'] = dict()
inputs['vmec']['dofs']['mpol'] = 6  # In G. Rawlinson input, this was set to VMEC resolution
inputs['vmec']['dofs']['ntor'] = 6  # In G. Rawlinson input, this was set to VMEC resolution
