...
# SURFACE
inputs['vmec'] = dict()
inputs['vmec']['filename'] = 'runs/2023-10-18T15:03:14/input.final' 
inputs['vmec']['verbose'] = False
inputs['vmec']['nphi'] = 34
inputs['vmec']['ntheta'] = 34

inputs['vmec']['dofs'] = dict()
inputs['vmec']['dofs']['mpol'] = 4  # In G. Rawlinson input, this was set to VMEC resolution
inputs['vmec']['dofs']['ntor'] = 4  # In G. Rawlinson input, this was set to VMEC resolution
