...
inputs['cnt_coils']['target']['IL_length_weight'] = Weight(1E-5)
...
inputs['numerics']['MAXITER_stage_1'] = 2 # NUmber of iteration for initial stage two optimization
inputs['numerics']['MAXITER_stage_2'] = 5 # NUmber of iteration for combined optimization
